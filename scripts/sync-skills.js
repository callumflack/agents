// Syncs .agents/skills into an editor target directory using symlinks; never removes existing links unless --prune is set.
import {
  existsSync,
  lstatSync,
  mkdirSync,
...
export const syncSkills = (targetDir = defaultTargetDir, options = {}) => {
  ...
  console.log(
    `[sync-skills] linked=${linked} removed=${removed} skipped=${skipped} conflicts=${conflicts} prune=${prune}`,
  );
